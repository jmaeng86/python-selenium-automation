...
def click_cart_icon(context):
    context.driver.find_elements(By.CSS_SELECTOR, '[data-test="@web/CartLink"]')[0].click()

@then('Verify Your cart is empty message is shown')
def verify_empty_cart(context):
    expected_text = 'Your cart is empty'
    actual_text = context.driver.find_element(By.XPATH,"//h1[contains(text(),'empty')]" ).text
    print(actual_text)
